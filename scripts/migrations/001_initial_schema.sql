...
-- =========================================================================
-- Creates the foundational NEXUS database: users, items, collections,
-- connections, AI queue, activity log, API keys, indexes, functions, triggers.
-- Up/Migrate: applies all statements
-- Down/Rollback: drops all created objects in reverse dependency order
-- =========================================================================
...
-- DROP TRIGGER trigger_notify_item_created ON items;
-- DROP FUNCTION notify_item_created();
-- DROP TRIGGER trigger_collection_item_count ON collection_items;
-- DROP FUNCTION update_collection_item_count();
-- DROP TRIGGER update_collections_updated_at ON collections;
-- DROP TRIGGER update_items_updated_at ON items;
-- DROP TRIGGER update_users_updated_at ON users;
-- DROP FUNCTION update_updated_at();
-- DROP FUNCTION search_items(vector(768), UUID, INT);
-- DROP POLICY api_keys_delete_policy ON api_keys;
-- DROP POLICY api_keys_insert_policy ON api_keys;
-- DROP POLICY api_keys_select_policy ON api_keys;
